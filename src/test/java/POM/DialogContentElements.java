...
public class DialogContentElements extends BasePOM {
    ...
    private WebElement nameSearchInput; //editlemek için aradığımız name
    ...
    private WebElement column2InTable;
    ...
    public void createCountry() {
        addButton.click();
        nameInput.sendKeys("az19");
        codeInput.sendKeys("az19");
        saveButton.click();
    }
    ...
    public void editCountry() {
        nameSearchInput.sendKeys("az19");
        searchButton.click();
        editButton.click();
        nameInput.clear();
        nameInput.sendKeys("az20");
        saveButton.click();
    }

    public void deleteCountry() {
        nameSearchInput.sendKeys("az20");
        searchButton.click();
